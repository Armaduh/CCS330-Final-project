...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//The following code take you to various shots in Orthographic projection mode and not.
	if (glfwGetKey(m_pWindow, GLFW_KEY_1) == GLFW_PRESS)
	{
		bOrthographicProjection = true;

		g_pCamera->Position = glm::vec3(0.0f, 8.0, 20.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_3) == GLFW_PRESS)
	{
		...
		g_pCamera->Position = glm::vec3(-20.0f, 18.0f, 15.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
		g_pCamera->Front = glm::vec3(2.0f, -2.0f, -2.0f);
	}
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_5) == GLFW_PRESS)
	{
		...
		g_pCamera->Position = glm::vec3(20.0f, 25.0f, 10.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
		g_pCamera->Front = glm::vec3(-1.0f, -1.0f, -1.0f);
		g_pCamera->Zoom = 80;
	}
